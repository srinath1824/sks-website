        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 max-w-md">
              Siva Kundalini Sadhana (SKS) is a non-profit organization founded by Parama Pujya SriJeeveswara Yogi, with a divine purpose of transforming every human life into a healthy and blissful journey towards self-realisation, through simple, safe and powerful Siva Kundalini Sadhana.
            </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <address className="text-gray-300 text-sm not-italic">
                    Nayal, Dunagiri, Himalayas<br />Uttarakhand, India
                  </address>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2017- 2025 Siva Kundalini Sadhana Foundation. All rights reserved.
            </p>
          </div>
        </div>
